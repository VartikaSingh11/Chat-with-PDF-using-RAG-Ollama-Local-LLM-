...
#Project Overview
This project implements a Retrieval-Augmented Generation (RAG) pipeline that allows users to ask questions from a PDF document using a local LLM (Llama2 via Ollama).
